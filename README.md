...
```
# Site settings
title: GXc-Tech Blog                   # 你的博客网站标题
SEOTitle: 鑫技术，新世界 | GXc-Tech Blog		# SEO 标题
description: "技术改变世界"	   	   # 随便说点，描述一下

# SNS settings      
github_username: guanxcode     # 你的github账号
jianshu_username: xxxxx  # 你的简书ID。
...
ga_domain: guanxcode.vip			# 默认的是 auto, 这里我是自定义了的域名，你如果没有自己的域名，需要改成auto。
```
...
我的博客标题是 **“鑫技术、新世界”** 但是我想要在搜索的时候显示 **“鑫技术、新世界 | GXc-Tech Blog”** ，这个就需要 SEO Title 来定义了。
