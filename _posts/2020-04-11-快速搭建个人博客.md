# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[GuanXcode Tech Blog](https://guanxcode.vip)搭建出来了。。。

本教程针对的是不懂技术又想搭建个人博客的小白，操作简单暴力且快速。当然懂技术那就更好了。

看看看博客的主页样式：

[![](http://upload-images.jianshu.io/upload_images/2178672-51a2fe6fbe24d1cd.jpg?imageMogr2/auto-orient/strip%7CimageView2/2/w/1240)](http://guanxcode.github.io/)

在手机上的布局：

[![](http://upload-images.jianshu.io/upload_images/2178672-d58bb45f9faedb70.jpg)](http://guanxcode.github.io/)
...
注册完成后搜索 `qiubaiying.github.io` 进入[我的仓库](https://github.com/GuanXcode/GuanXcode.github.io)
...
这时你在在浏览器中输入 `你的Github账号名.github.io` 例如:`GuanXcode.github.io`
...
keyword: "BY, BY Blog, 鑫哥的博客, GuanXcode, 关鑫, iOS, Apple, iPhone" #关键词
url: "https://GuanXcode.github.io"          # 这个就是填写你的博客地址
baseurl: ""      # 这个我们不用填写
...
搭建好博客之后 你可能不想直接使用 [GuanXcode.github.io](http://GuanXcode.github.io) 这么长的博客域名吧, 想换成想 [guanxcode.vip](https://guanxcode.vip) 这样简短的域名。那我们开始吧！
...
一个主机记录为 `www`,代表可以解析 `www.guanxcode.vip`的域名

另一个为 `@`, 代表 `guanxcode.vip`
...
若本教程顺利帮你搭建了自己的个人博客，请不要 **害羞**，给我的 [github仓库](https://github.com/guanxcode/guanxcode.github.io) 点个 **star** 吧！
