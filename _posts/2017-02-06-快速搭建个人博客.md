...
> 
> [我的的博客](http://GuanXcode.vip)

# 前言
从 Jekyll 到 GitHub Pages 中间踩了许多坑，终于把我的个人博客[BY Blog](http://GuanXcode.vip)搭建出来了。。。
...
注册完成后搜索 `GuanXcode.github.io` 进入[我的仓库](https://github.com/GuanXcode/GuanXcode.github.io)
...
keyword: "BY, BY Blog, 你的博客, GuanXcode, 你, iOS, Apple, iPhone" #关键词
...
> 很对人反映 Disqus 评论插件加载不出来，因为 Disqus 在国内加载缓慢，所以我新集成了 Gitalk 评论插件（感谢[@FeDemo](https://github.com/FeDemo)的推荐），喜欢折腾的朋友可以看这篇：[《为博客添加 Gitalk 评论插件》](http://GuanXcode.top/2017/12/19/%E4%B8%BA%E5%8D%9A%E5%AE%A2%E6%B7%BB%E5%8A%A0-Gitalk-%E8%AF%84%E8%AE%BA%E6%8F%92%E4%BB%B6/)。 我已经在`_config.yml` 配置就好了，只需要填写参数可以了。
...
搭建好博客之后 你可能不想直接使用 [baiyingqiu.github.io](http://baiyingqiu.github.io) 这么长的博客域名吧, 想换成想 [GuanXcode.vip](http://GuanXcode.vip) 这样简短的域名。那我们开始吧！
...
用**阿里云** app也可以注册域名，域名的价格根据后缀的不同和域名的长度而分，比如我这个 `GuanXcode.vip` 的域名第一年才只要4元~
...
### **别无他求，点个 [Star](https://github.com/GuanXcode/GuanXcode.github.io) 吧**！
